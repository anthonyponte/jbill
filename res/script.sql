...
CREATE TABLE RESUMEN_DIARIO_DETALLE (
    ...
    PERCEPCION_CODIGO VARCHAR(2),
    PERCEPCION_DESCRIPCION VARCHAR(100),
    PERCEPCION_TASA FLOAT,
    ...
    MONEDA_TIPO VARCHAR(3) NOT NULL,
